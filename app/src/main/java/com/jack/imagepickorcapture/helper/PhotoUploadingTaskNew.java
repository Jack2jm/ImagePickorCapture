...
public class PhotoUploadingTaskNew {
	...
	public PhotoUploadingTaskNew(Context activity, String event_id, String email, ArrayList<Image> mSelectedImages, OnPhotoUpload uploadCallBack) {
		this.Email = email;
	...
	private class photoUploadServer extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			//LOGD(TAG, result);
			//System.out.println("============= photo uploadinh task result "+result);
			if (result != null) {
				try {
