...
public class Constants {
    ...
    public static final int REQUEST_ADD_MORE_CODE = 2012;
    public static final int REQUEST_REPLACE_CODE = 2010;
    ...
    public static final String INTENT_EXTRA_SINGLE_SELECT = "singleselect";
    public static final int DEFAULT_LIMIT = 8;

    //Maximum number of images that can be selected at a time
    public static int limit;
    public static boolean singleselect;
}
